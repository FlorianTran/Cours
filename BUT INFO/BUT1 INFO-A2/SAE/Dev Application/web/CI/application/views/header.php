    ...
    <header>
      <nav class="nav">
          ...
          <ul>
            ...
            <ul class="nav-links">
              <li class="location-nav">
                <a href="#">
                  <img src=<?=base_url()."public\img\logo_loc.svg" ?> alt="logo location" />
                  <p>Location</p>
                </a>
              </li>
              <li class="connexion-nav">
                ...
                <a href="<?=base_url().'index.php/User/display/'.$username?>">
                  <img src=<?=base_url()."public\img\logo_co.svg" ?> alt="logo connexion" />
                  <p>Connexion</p>
                </a>
              ...
              <li class="cart-nav">
                <a href="<?=base_url().'index.php/Home/cart'?>">
                  <img src=<?=base_url()."public\img\logo_cart.svg" ?> alt="logo cart" />
                  <p>Panier</p>
                </a>
              </li>
            </ul>
            <li>
              <img src=<?=base_url()."public\img\menu-btn.png"?>  alt="menu bouton" class="menu-btn">
            </li>
          </ul>
        ...
        <div class="under-container" id="undercontainer">
          <ul class="nav-bar">
            <li class="nav-item">
              <a href="#" class="nav-link skateboard" id="skateboard"
                >SKATEBOARD</a
              >
            ...
            <li class="nav-item">
              <a href="#" class="nav-link accesories" id="accesories"
                >ACCESOIRES</a
              >
              <span class="menu-nav"></span>
            </li>
